...
//var netmonLog = logrus.WithField("source", "netmon")
...
func StartNetMon(ctx context.Context, Sandbox vc.VCSandbox) {
	sandbox = Sandbox
	...
	// n.logger().Info("GO IN TO StartNetMon !!!!!!!!!!!!!!! ")
